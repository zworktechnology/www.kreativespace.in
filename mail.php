...
$mail->setFrom('no-reply@uniqueconstructionstrichy.com', 'Kreative Space Construction');
$mail->addAddress('harishcs2002@gmail.com');
$mail->addBCC('testing.zworktechnology@gmail.com');

$mail->isHTML(true);                                  // Set email format to HTML

$mail->Subject = 'Enquiry from Submission mail from Kreative Space Construction';
